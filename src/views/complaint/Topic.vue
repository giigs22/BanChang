                ...
                <div class="main-content">
                    <div class="block-content mb-5">
                        ...
                        <div class="searchbox mt-5 mb-5">
                            <h3 class="text-lg dark:text-white">{{$t('all_complaint_topic')}}</h3>
                            <div class="flex flex-col lg:flex-row justify-between form-search">
                                <div class="col-span-full lg:col-span-2 my-5">
                                <a class="btn-purple rounded btn-blue-gradient" href="/complaint_topic/create">{{$t('create_complaint_topic')}}</a>
                                </div>
                                <div class="col-span-full lg:col-span-2">
                                    <input type="text" placeholder="ID,Topic" class="form-input">
                           ...
                           <table class="table  border-collapse w-full rounded">
                            ...
                            <tbody class="bg-body-table dark:text-white">
                                <tr class="border-b dark:border-gray-600 border-slate-300">
                                    <td class="text-center border-r border-gray-600 p-3"></td>
                                    <td class="text-center border-r border-gray-600 p-3"></td>
                                    <td class="text-center border-r border-gray-600 p-3"></td>
                                    <td class="text-center border-r border-gray-600 p-3"></td>
                                    <td class="text-center border-r border-gray-600 p-3"></td>
                                    <td class="text-center"><a class="dark:text-cyan-300 text-cyan-800">Edit</a> | <button class="text-red-500">Delete</button></td>
                                </tr>
