            ...
            <div class="inner-content mx-4 lg:mx-10">
                <div class="main-content">
                    <div class="block-content mb-5">
                        ...
                        <h1 class="text-xl dark:text-white ml-10">{{$t('edit_device')}}</h1>
                        <div class="form-register mt-5 mb-5">
                            <Form @submit="updateWidget" :validation-schema="schema">
                                ...
                                <div class="flex gap-3 justify-end mt-10">
                                    <button type="submit" class="px-5 py-2 rounded-md text-white btn-blue-gradient">{{$t('update_device')}}</button>
                                    <button type="reset"
